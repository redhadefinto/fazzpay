    ...
    <>
      <PrivateRoute>
        ...
        <div
          ...
          <button
            className="drawer-button py-8 bg-blue-900 absolute top-[40%] right-[-8%] md:right-[-4%] rounded-r-3xl hover:bg-blue-700 hover:delay-100 hover:transition-all cursor-pointer lg:hidden"
            onClick={toggleSidebar}>
            <i class="bi bi-arrow-bar-right text-white font-bold text-2xl"></i>
          </button>
          <Link
              ...
              <div className="bg-white lg:w-[60%] py-8 mb-12 lg:mb-0 rounded-xl">
                <div className="flex bg-white">
                  <div className="w-[60%] flex flex-col items-center">
                    ...
                    <p className="text-grey-primary font-semibold">
                      Rp2.120.000
                    </p>
                  </div>
